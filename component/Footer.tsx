...
export default function Footer() {
  return (
    <footer className="relative bg-slate-950 border-t border-slate-800/80 text-slate-400 mt-auto overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 lg:gap-12">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <div className="pt-2">
              <Link
                href="/profile"
                className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-slate-900 border border-slate-800 hover:border-indigo-500/50 text-xs text-slate-300 hover:text-white transition-all duration-200"
              >
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              <li>
                <Link href="/discussions" className="hover:text-white transition-colors duration-200">
                  Discussions
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/guidelines" className="hover:text-white transition-colors duration-200">
                  Guidelines
                </Link>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            ...
            <form className="flex items-center gap-2">
              <input
                ...
                className="w-full px-3 py-2 rounded-lg bg-slate-900 border border-slate-800 text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-indigo-500/60"
              />
              <button
                type="submit"
                className="px-3.5 py-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 text-white text-xs font-medium transition-colors duration-200 flex-shrink-0"
              >
                Join
              </button>
            </form>
