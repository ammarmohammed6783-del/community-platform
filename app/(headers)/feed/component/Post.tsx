...
export default function Post({ post }: { post: { id: string | number; content: string; createdAt?: Date } }) {
  const [liked, setLiked] = useState(false);
  const [likesCount, setLikesCount] = useState(Math.floor(Math.random() * 12) + 1);
